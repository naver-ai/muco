...
def data_prepare(batch_dict, *args, **kwargs):
    ...
    for qry_inst, qry_text, qry_img_path, tgt_texts, tgt_img_paths in (
...
def load_image_qa_dataset(model_args, data_args, *args, **kwargs):
    ...
    dataset = load_dataset(os.path.join(data_args.data_basedir, dataset_name), split="test")
